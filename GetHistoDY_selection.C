...
//      if(MT>150 && MET>300 && minDPhi>0.8 && MT2W>200 && fabs(ak10pfjets_p4()[0].eta()) < 2.4 &&boostjet_ak10_pt>300 && cms3.ak10pfjets_trimmed_mass()[0]>75&&Gettopness_(MET,METPhi,leplv,btaggedjets,1)>7){
      ...
      if(MET>300) histos_cutflow["NEventsPerSignalRegion_boost1_"+samplename]  ->Fill(0.5,weight);
      if(MET>350) histos_cutflow["NEventsPerSignalRegion_boost1_"+samplename]  ->Fill(1.5,weight);
      if(MET>400) histos_cutflow["NEventsPerSignalRegion_boost1_"+samplename]  ->Fill(2.5,weight);
      if(MET>450) histos_cutflow["NEventsPerSignalRegion_boost1_"+samplename]  ->Fill(3.5,weight);
...
//      if(SR_boost_300_mass75 && jetlv[0].pt()>70 && jetlv[1].pt()>70&&jetlv[2].pt()>50){
      if(MET>300) histos_cutflow["NEventsPerSignalRegion_boost2_"+samplename]  ->Fill(0.5,weight);
      if(MET>350) histos_cutflow["NEventsPerSignalRegion_boost2_"+samplename]  ->Fill(1.5,weight);
      if(MET>400) histos_cutflow["NEventsPerSignalRegion_boost2_"+samplename]  ->Fill(2.5,weight);
      if(MET>450) histos_cutflow["NEventsPerSignalRegion_boost2_"+samplename]  ->Fill(3.5,weight);
