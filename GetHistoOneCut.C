...
int ScanChain( TChain* chain, bool fast = true, int nEvents = -1, string skimFilePrefix = "test") {
  ...
  //histonames.push_back("MT2_lb_bq_boost_mless"); histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(750.);
  histonames.push_back("MT2_lb_bqq_mless");      histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(750.);
  //histonames.push_back("MT2_l_q_boost");      histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(750.);
  ...
  histonames.push_back("MTq_boost");          histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(1500.);
  histonames.push_back("MTq_boostmax");       histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(1500.);
  histonames.push_back("MTq_boost200");       histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(1500.);
  histonames.push_back("MTq_boost300");       histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(1500.);
  histonames.push_back("MTq_boost400");       histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(1500.);
  histonames.push_back("MTq_boost450");       histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(1500.);
  histonames.push_back("MTq_boost500");       histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(1500.);
  histonames.push_back("MTq_boostLeadJet");   histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(1500.);
  histonames.push_back("MTq_boostLeadJet300");histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(1500.);
  histonames.push_back("MTq_boostLeadJetgt300");histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(1500.);
  histonames.push_back("MTq_boostLeadJetlt300");histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(1500.);
  histonames.push_back("MTq_boostLeadJetgt400");histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(1500.);
  histonames.push_back("MTq_boostLeadJetlt400");histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(1500.);
  ...
  histonames.push_back("sumak8topmass");      histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(750.);
  histonames.push_back("sumak8prunedmass");   histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(750.);
  histonames.push_back("sumak8trimmedmass");  histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(750.);
  histonames.push_back("sumak8filteredmass"); histobinn.push_back(30); histobinl.push_back(0.); histobinu.push_back(750.);
  ...
  while ( (currentFile = (TFile*)fileIter.Next()) ) {
	...
	//if(fabs(lep1eta)<2.1&&cms3.lep1_is_phys14_medium_noIso()&&cms3.lep1_miniRelIsoDB()<0.1) {++NSLeps; l1 = 1; }
      }
      /*
      if(lep2ismu){
	...
	value[histonames[i] ] = -1;//reset values
      ...
      //value["MT2_lb_bq_boost_mless"] = MT2_lb_bq_( MET,METPhi,leplv,btaggedjets,boostjetlv,false,0);;//might not work
      //value["MT2_lb_bq_boost"]       = MT2_lb_bq_( MET,METPhi,leplv,btaggedjets,boostjetlv,true ,0);//might not work
      ...
      //value["MT2_l_q_boost"]         = MT2_lb_bq_( MET,METPhi,leplv,dummybjets,boostjetlv,true ,0);//might not work
	...
	if(JetUtil::deltaPhi(jetlv[n],leplv)>dP1l){ bj3 = bj2; bj2 = bj1; bj1 = n;}
      ...
      if(myleadjpt>300) value["MTq_boostLeadJetgt300"] = value["MTq_boostLeadJet"];
      if(myleadjpt<300) value["MTq_boostLeadJetlt300"] = value["MTq_boostLeadJet"];
      if(myleadjpt>400) value["MTq_boostLeadJetgt400"] = value["MTq_boostLeadJet"];
      if(myleadjpt<400) value["MTq_boostLeadJetlt400"] = value["MTq_boostLeadJet"];
      
      LorentzVector bjsumlep = jetlv[bj1] + jetlv[bj2] + jetlv[bj3];
      value["M3b"] = bjsumlep.M();

      float top(0.),trim(0.),prune(0.),filter(0.);
      for(unsigned int n = 0; n<cms3.ak8pfjets_top_mass().size();++n) top = top + cms3.ak8pfjets_top_mass()[n];
      for(unsigned int n = 0; n<cms3.ak8pfjets_trimmed_mass().size();++n) trim += cms3.ak8pfjets_trimmed_mass()[n];
      for(unsigned int n = 0; n<cms3.ak8pfjets_pruned_mass().size();++n) prune += cms3.ak8pfjets_pruned_mass()[n];
      for(unsigned int n = 0; n<cms3.ak8pfjets_filtered_mass().size();++n) filter += cms3.ak8pfjets_filtered_mass()[n];
      
      //cout << __LINE__<<endl;
      value["sumak8topmass"]      = top;
      value["sumak8prunedmass"]   = prune;
      value["sumak8trimmedmass"]  = trim;
      value["sumak8filteredmass"] = filter;
      value["MT"] = MT;
      value["MET"] = MET;
      value["HT"] = HT;
      if(HT>0) {
	...
	string mname;
	if(MET300_noMT){
	  mname= "MET300_noMT"+d+histonames[i]+d+samplename;
	  histos[mname]->Fill(value[histonames[i] ],weight);
	}
	if(MET100_MT120){
	  mname= "MET100_MT120"+d+histonames[i]+d+samplename;
	  histos[mname]->Fill(value[histonames[i] ],weight);
	}
	if(noMT){
	  mname= "noMT"+d+histonames[i]+d+samplename;
	  histos[mname]->Fill(value[histonames[i] ],weight);
	}
	if(MT80){
	  mname= "MT80"+d+histonames[i]+d+samplename;
	  histos[mname]->Fill(value[histonames[i] ],weight);
	}
	if(MT100){
	  mname= "MT100"+d+histonames[i]+d+samplename;
	  histos[mname]->Fill(value[histonames[i] ],weight);
	}
	if(MT125){
	  mname= "MT125"+d+histonames[i]+d+samplename;
	  histos[mname]->Fill(value[histonames[i] ],weight);
	}
	if(MT150){
	  mname= "MT150"+d+histonames[i]+d+samplename;
	  histos[mname]->Fill(value[histonames[i] ],weight);
	}
	if(SR){
	...
	if(SR&&(MET>200)){
	  mname = "SR200"+d+histonames[i]+d+samplename;
	  histos[mname]->Fill(value[histonames[i] ],weight);
	}
	if(SR&&(MET>200)&&(MT2W>200)){
	  mname = "SR200MT2W"+d+histonames[i]+d+samplename;
	  histos[mname]->Fill(value[histonames[i] ],weight);
	}
      }
      if(!SR && SRbutMT) histos["SR_MT_"+samplename]->Fill(value["MT"],weight);
      if(!SR && SRbutMET) histos["SR_MET_"+samplename]->Fill(value["MET"],weight);
      if(!SR && SRbutMT2W) histos["SR_MT2W_"+samplename]->Fill(value["MT2W"],weight);
      if(!SR && SRbutchi2) histos["SR_chi2_"+samplename]->Fill(value["chi2"],weight);
      if(!SR && SRbutminDPhi) histos["SR_minDPhi_"+samplename]->Fill(value["minDPhi"],weight);

      if(!SR && SRbutMT&&(MET>200)) histos["SR200_MT_"+samplename]->Fill(value["MT"],weight);
      if(!SR && SRbutMET) histos["SR200_MET_"+samplename]->Fill(value["MET"],weight);
      if(!SR && SRbutMT2W&&(MET>200)) histos["SR200_MT2W_"+samplename]->Fill(value["MT2W"],weight);
      if(!SR && SRbutchi2&&(MET>200)) histos["SR200_chi2_"+samplename]->Fill(value["chi2"],weight);
      if(!SR && SRbutminDPhi&&(MET>200)) histos["SR200_minDPhi_"+samplename]->Fill(value["minDPhi"],weight);

      if(!SR && SRbutMT&&(MET>200)&&(MT2W>200)) histos["SR200MT2W_MT_"+samplename]->Fill(value["MT"],weight);
      if(!SR && SRbutMET&&(MT2W>200)) histos["SR200MT2W_MET_"+samplename]->Fill(value["MET"],weight);
      if(!SR && SRbutMT2W&&(MET>200)) histos["SR200MT2W_MT2W_"+samplename]->Fill(value["MT2W"],weight);
      if(!SR && SRbutchi2&&(MET>200)&&(MT2W>200)) histos["SR200MT2W_chi2_"+samplename]->Fill(value["chi2"],weight);
      if(!SR && SRbutminDPhi&&(MET>200)&&(MT2W>200)) histos["SR200MT2W_minDPhi_"+samplename]->Fill(value["minDPhi"],weight);
