#include "StopBabies08052015.h"
StopBabies08052015 cms3;
namespace tas {
	...
	const int &ca12GoodPFJets() { return cms3.ca12GoodPFJets(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ca12pfjets_p4() { return cms3.ca12pfjets_p4(); }
	const vector<float> &ca12pfjets_tau1() { return cms3.ca12pfjets_tau1(); }
	const vector<float> &ca12pfjets_tau2() { return cms3.ca12pfjets_tau2(); }
	const vector<float> &ca12pfjets_tau3() { return cms3.ca12pfjets_tau3(); }
	const vector<float> &ca12pfjets_top_mass() { return cms3.ca12pfjets_top_mass(); }
	const vector<float> &ca12pfjets_pruned_mass() { return cms3.ca12pfjets_pruned_mass(); }
	const vector<float> &ca12pfjets_trimmed_mass() { return cms3.ca12pfjets_trimmed_mass(); }
	const vector<float> &ca12pfjets_filtered_mass() { return cms3.ca12pfjets_filtered_mass(); }
	const int &ca10GoodPFJets() { return cms3.ca10GoodPFJets(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ca10pfjets_p4() { return cms3.ca10pfjets_p4(); }
	const vector<float> &ca10pfjets_tau1() { return cms3.ca10pfjets_tau1(); }
	const vector<float> &ca10pfjets_tau2() { return cms3.ca10pfjets_tau2(); }
	const vector<float> &ca10pfjets_tau3() { return cms3.ca10pfjets_tau3(); }
	const vector<float> &ca10pfjets_top_mass() { return cms3.ca10pfjets_top_mass(); }
	const vector<float> &ca10pfjets_pruned_mass() { return cms3.ca10pfjets_pruned_mass(); }
	const vector<float> &ca10pfjets_trimmed_mass() { return cms3.ca10pfjets_trimmed_mass(); }
	const vector<float> &ca10pfjets_filtered_mass() { return cms3.ca10pfjets_filtered_mass(); }
	const int &ak10GoodPFJets() { return cms3.ak10GoodPFJets(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ak10pfjets_p4() { return cms3.ak10pfjets_p4(); }
	const vector<float> &ak10pfjets_tau1() { return cms3.ak10pfjets_tau1(); }
	const vector<float> &ak10pfjets_tau2() { return cms3.ak10pfjets_tau2(); }
	const vector<float> &ak10pfjets_tau3() { return cms3.ak10pfjets_tau3(); }
	const vector<float> &ak10pfjets_top_mass() { return cms3.ak10pfjets_top_mass(); }
	const vector<float> &ak10pfjets_pruned_mass() { return cms3.ak10pfjets_pruned_mass(); }
	const vector<float> &ak10pfjets_trimmed_mass() { return cms3.ak10pfjets_trimmed_mass(); }
	const vector<float> &ak10pfjets_filtered_mass() { return cms3.ak10pfjets_filtered_mass(); }
	const int &ak12GoodPFJets() { return cms3.ak12GoodPFJets(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ak12pfjets_p4() { return cms3.ak12pfjets_p4(); }
	const vector<float> &ak12pfjets_tau1() { return cms3.ak12pfjets_tau1(); }
	const vector<float> &ak12pfjets_tau2() { return cms3.ak12pfjets_tau2(); }
	const vector<float> &ak12pfjets_tau3() { return cms3.ak12pfjets_tau3(); }
	const vector<float> &ak12pfjets_top_mass() { return cms3.ak12pfjets_top_mass(); }
	const vector<float> &ak12pfjets_pruned_mass() { return cms3.ak12pfjets_pruned_mass(); }
	const vector<float> &ak12pfjets_trimmed_mass() { return cms3.ak12pfjets_trimmed_mass(); }
	const vector<float> &ak12pfjets_filtered_mass() { return cms3.ak12pfjets_filtered_mass(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ca12genjets_p4() { return cms3.ca12genjets_p4(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ca10genjets_p4() { return cms3.ca10genjets_p4(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ak10genjets_p4() { return cms3.ak10genjets_p4(); }
	const vector<ROOT::Math::LorentzVector<ROOT::Math::PxPyPzE4D<float> > > &ak12genjets_p4() { return cms3.ak12genjets_p4(); }
