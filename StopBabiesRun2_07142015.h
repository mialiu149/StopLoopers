// -*- C++ -*-
#ifndef StopBabiesRun2_07142015_H
#define StopBabiesRun2_07142015_H
...
protected: 
	...
	int	HLT_EMu_;
	TBranch *HLT_EMu_branch;
	bool HLT_EMu_isLoaded;
	int	HLT_MuE_;
...
void Init(TTree *tree) {
  ...
  tree->SetMakeClass(1);
	...
	HLT_EMu_branch = 0;
	if (tree->GetBranch("HLT_EMu") != 0) {
		HLT_EMu_branch = tree->GetBranch("HLT_EMu");
		if (HLT_EMu_branch) {HLT_EMu_branch->SetAddress(&HLT_EMu_);}
	}
	HLT_MuE_branch = 0;
	...
	// load all branches
{
	...
	int &HLT_EMu()
	{
		if (not HLT_EMu_isLoaded) {
			if (HLT_EMu_branch != 0) {
				HLT_EMu_branch->GetEntry(index);
			} else { 
				printf("branch HLT_EMu_branch does not exist!\n");
				exit(1);
			}
			HLT_EMu_isLoaded = true;
		}
		return HLT_EMu_;
	}
	int &HLT_MuE()
...
#ifndef __CINT__
extern StopBabiesRun2_07142015 cms3;
#endif
