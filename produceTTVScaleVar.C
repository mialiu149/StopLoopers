{
  ...
  gROOT->ProcessLine(".L GetHistoScaleVar.C+");
  
  const unsigned int chainsize = 1;
  TChain *ch[chainsize];
  string dataset[chainsize];
  string babylocation = "/nfs-7/userdata/mliu/ttz/scale_unc/";
  string helper;
/*  dataset[0] = "TTbar";
  ch[0] = new TChain("t"); 
 ...
 */
  dataset[0] = "ttz_zllnunu_25ns";
  ch[0] = new TChain("t"); 
  helper = babylocation+"ttz_zllnunu_25ns.root";      ch[0]->Add(helper.c_str());
//  dataset[1] = "dyjets";
//  ch[1] = new TChain("t"); 
