...
float topnessMinimization(TLorentzVector lep, TLorentzVector bjet1, TLorentzVector bjet2, TLorentzVector met) {
    ...
    // minimizer->ExecuteCommand("migradimproved",0,0);
    ...
    return log(printtopnessFunction(pwx_fit,pwy_fit,pwz_fit,pnz_fit,
                               iLpx,iLpy,iLpz,iLpe,
...
float topnessMinimization2(TLorentzVector lep, TLorentzVector bjet1, TLorentzVector bjet2, TLorentzVector met) {
    ...
    delete minimizer;
    // get the function value at best fit
    return log(printtopnessFunction2(pwx_fit,pwy_fit,pwz_fit,pnz_fit,
                               iLpx,iLpy,iLpz,iLpe,
                               iB1px,iB1py,iB1pz,iB1pe,
                               iB2px,iB2py,iB2pz,iB2pe,
                               iMpx,iMpy,iMpz,iMpe
...
double printtopnessFunction2(double pwx_, double pwy_, double pwz_, double pnz_,
    ...
    double Topness = tWM + tWL + 0 + tTM + 0;
    //double Topness = tTL;
    return Topness;
}

double printtopnessFunction(double pwx_, double pwy_, double pwz_, double pnz_,
                       double plx_, double ply_, double plz_, double ple_,
                       double pb1x_, double pb1y_, double pb1z_, double pb1e_,
                       double pb2x_, double pb2y_, double pb2z_, double pb2e_,
                       double pmx_, double pmy_, double pmz_, double pme_) {
